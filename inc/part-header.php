...
<div class="row align-items-center m-0 py-3">
    ...
    <div class="col-md-4 ps-md-0 text-center text-md-end mt-2 mt-md-0">
        ...
        <form class="mb-2" method="get" name="searchform" action="<?php echo get_home_url();?>">
...
<div class="row align-items-center m-0 py-md-1 py-2">
	<div class="col-md-2 py-2 text-center d-md-flex d-none">
		<div class="text-center col-12 px-0 fw-bold text-uppercase">Breaking News</div>
	</div>
	<div class="col-md-10">
        <div class="color-theme bg-white">
            <div class="velocity-marquee-content">
                ...
                foreach($headerposts as $post) {
                    echo '<a class="text-color-theme fw-bold py-1 px-2" href="'.get_the_permalink($post->ID).'"><span class="carousel-title">'.get_the_title($post->ID).'</span></a>';
                } ?>
            </div>
        </div>
	</div>
