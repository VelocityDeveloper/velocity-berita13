...
<div class="container">
    <div class="row">
        <div class="col-12 mb-3">
            <div class="py-2 px-3 fw-bold fs-6 bg-dark text-white mb-2">PILIHAN EDITOR</div>
            <?php velocity_post_carousel(velocitytheme_option('cat_pilihan_editor'));?>
        </div>
        <div class="col-md-8">
            ...
            <div class="velocity-card"><?php velocity_posts(velocitytheme_option('cat_berita1')); ?></div>
            <div class="velocity-card"><?php velocity_post_carousel(velocitytheme_option('cat_berita2'),3,true); ?></div>
            <div class="velocity-card"><?php velocity_post_carousel(velocitytheme_option('cat_berita3'),3,true); ?></div>
            <div class="velocity-card"><?php velocity_posts_gallery(velocitytheme_option('cat_berita4'),true); ?></div>
            <div class="row">
                <div class="col-sm-6">
                    <div class="velocity-card"><?php velocity_posts_list(velocitytheme_option('cat_berita5')); ?></div>
                </div>
                <div class="col-sm-6">
                    <div class="velocity-card"><?php velocity_posts_list(velocitytheme_option('cat_berita6')); ?></div>
                </div>
            </div>
